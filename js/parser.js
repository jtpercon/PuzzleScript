	                ...
	                default://if you're in the preamble
	                {
	            		...
	            		if (state.tokenIndex==0) {
		                    ...
		                    if (match!==null) {
		                    	...
		                    	if (sol) {
		                    	    if (['title','author','homepage','background_color','text_color','key_repeat_interval','realtime_interval','again_interval','flickscreen','zoomscreen','color_palette','youtube','music'].indexOf(token)>=0) {
		                    			
                                        if (token==='youtube' || token==='music' || token==='author' || token==='title') {
